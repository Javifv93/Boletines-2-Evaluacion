...
public class Main 
{
	...
	/** El siguiente método estába pensado para que al salir del programa se borraran
	 ...
	 * va. Probe de distintas formas, hasta creando archivos temporales, pero no encontré
	 * manera de arreglarlo y ya perdí un par de tardes solo con esto.
	 * Así que aquí lo dejo, debugeando lo que alcanzé a comprender es que no debe de tener
	 * los permisos suficientes para borrarlos o algo así, ya que llegado a cierto punto
	 * da false en una movida de security noseque.
	 * Me hubiera gustado acabarlo, pero no puedo perder más tiempo con esto.
	 * Como anécdota, si las carpetas estan vacias si que las borra.
	 */
